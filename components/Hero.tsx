    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-20 mt-20 md:mt-0">
        <div className="max-w-2xl">
          ...
          >
            <h1 className="font-serif text-5xl md:text-6xl lg:text-7xl text-graphite leading-tight mb-6">
              Realce sua{" "}
              <span className="italic text-[#E2725B]">Beleza Natural</span> com
              Técnicas de Excelência
            </h1>

            <p className="font-sans text-graphite/80 text-lg leading-relaxed mb-8 border-l-2 border-[#E2725B] pl-6">
